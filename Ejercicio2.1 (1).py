#1.- Escribir una clase ColaDePacientes, con los métodos nuevo_paciente, que
#reciba el nombre de paciente y lo encole, y un método proximo_paciente que
#devuelva el primer paciente en cola y lo desencole.
