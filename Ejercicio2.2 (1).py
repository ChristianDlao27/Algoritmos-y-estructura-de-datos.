#2.-Escribir una clase Recepción, que contenga un diccionario con las colas
#correspondientes a cada doctor o doctora, y los métodos nuevos_paciente que 
#reciba el nombre del paciente y del especialista, y proximo_paciente que 
#reciba el nombre de la pesona liberada y devuelva el próximo paciente en 
#espera.
