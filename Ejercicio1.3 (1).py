#3.-Escribir un método acción, que haga aterrizar o bien despegar, al primero
#de los aviones que este esperando (los que esperen para aterrizar tienen
#prioridad). Debe desencolar el avion de su cola y devolver la información
#correspondiente.
